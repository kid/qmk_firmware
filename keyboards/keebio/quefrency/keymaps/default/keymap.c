...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  TT(_FNB),          KC_SPC,  TT(_FNB),KC_RGUI, KC_RALT, KC_LCTL, TT(_FNB), KC_PGDOWN
  ),
  ...
  [_MAC] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_PGUP, \
    KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  TT(_FNM),          KC_SPC,  TT(_FNM),KC_RALT, KC_RGUI, KC_LCTL, TT(_FNM), KC_PGDOWN
  ),

  [_FNM] = LAYOUT(
    KC_GRAVE,KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,   KC_F12,  _______,  KC_DELETE, \
    RGB_TOG, RGB_MOD, KC_UP,   _______, _______, _______,  _______, _______, _______, _______, _______, KC__VOLDOWN,KC__VOLUP, KC__MUTE, \
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, DF(_GAME),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,  _______,\
    _______, _______, _______, _______, _______, DF(_BASE),_______, DF(_MAC),_______, _______, _______, _______,  KC_HOME, \
    KC_TILD, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______,  KC_END
  ),
  ...
  [_GAME] = LAYOUT(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  KC_ENT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_PGUP, \
    KC_LCTL, KC_F13,  KC_LALT, KC_SPC,  TT(_FNG),          KC_SPC,  TT(_FNG),KC_RGUI, KC_RALT, KC_LCTL, TT(_FNG), KC_PGDOWN
  ),
