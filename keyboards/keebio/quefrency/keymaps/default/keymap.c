...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  TT(_FNB),          KC_SPC,  TT(_FNB),KC_RGUI, KC_RALT, KC_LCTL, TT(_FNB), KC_PGDN
  ),
  ...
  [_GAME] = LAYOUT(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,  KC_ENT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,     KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,  KC_PGUP, \
    KC_LCTL, KC_F13,  KC_LALT, KC_SPC,  TT(_FNG),          KC_SPC,  TT(_FNG),KC_RGUI, KC_RALT, KC_LCTL, TT(_FNG), KC_PGDN
  ),
